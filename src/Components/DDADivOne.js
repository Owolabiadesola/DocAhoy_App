...
const DDADivOne = () => {
  return (
    <div>
      <span>
        <h3 style={{ margin: "3rem 0 0 5rem" }}> Doctor's in Abuja</h3>
      </span>
      <span>
        <img
      ...
      >
        ...
        <div class="col-sm-4 mt-4">
          {" "}
          <h4>Dr. Usman Musa</h4>
          <h6 class="text-light">Neuro Surgeon</h6>
          ...
          <p style={{ fontSize: "0.7rem" }}>
            Neurosurgeons perform surgery on your nervous system, brain, spinal
            cord and nerves.
          </p>
          <p style={{ fontSize: "0.7rem" }}>Maitama</p>
          <h6 style={{ fontSize: "0.8rem" }}>Joined 2019</h6>
        ...
        <div class="col-sm-4">
          ...
          >
            <a href="/BookingPageAbj1" class="text-decoration-none text-light">
              Book Now
            </a>
          </button>
        </div>
