      ...
      >
        ...
        <div class="col-sm-4 mt-4">
          ...
          <p style={{ fontSize: "0.7rem" }}>
            Practitioner specializing in the diagnosis and treatment of skin
            disorders.
          </p>
          <p style={{ fontSize: "0.7rem" }}>Jabi</p>
        ...
        <div class="col-sm-4">
          ...
          >
            <a href="/BookingPageAbj2" class="text-decoration-none text-light">
              Book Now
            </a>
          </button>
        </div>
